...
namespace Memento
{
    ...
    /// </summary>
    public class EmployeeManagerRespoitory : IEmployeeManagerRepository
    {
        ...
        /// <summary>
        /// For demo purposes, wirte out the data store to the console window
        /// </summary>        
    ...
    public class CommandManager
    {
        ...
        {
            // if the comand has not been stored yet, store it - we will
